  ...
  return new Promise(function (resolve, reject) {
    _tmp["default"].dir(function (err, dir, cleanupCallback) {
      ...
      return (0, _axios["default"])({
        ...
        var redirectedUrl = response.request._redirectable && response.request._redirectable._redirectCount > 0 ? response.request._redirectable._currentUrl : response.config.url;
